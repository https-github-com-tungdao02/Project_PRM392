        ...
        buttonAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (email.isEmpty() || user.isEmpty() || password.isEmpty() || phone.isEmpty() || address.isEmpty() || image.isEmpty()) {
                    ...
                    database.child("users").child(user).setValue(new User(id, user,password,role,phone,address,image,gender, email)).addOnSuccessListener(new OnSuccessListener<Void>() {
                        @Override
